...
{
    CHECK(LogicUtils::IIf(true, 1, 2) == 1);
    CHECK(LogicUtils::IIf(false, 1, 2) == 2);
}
TEST_CASE("LogicUtils::Choose", "[LogicUtils]")
{
    CHECK(LogicUtils::Choose(1, 1.0, 2.0, 3.0, 4.0) == 1.0);
    CHECK(LogicUtils::Choose(2, 1.0, 2.0, 3.0, 4.0) == 2.0);
    CHECK(LogicUtils::Choose(3, 1.0, 2.0, 3.0, 4.0) == 3.0);
    CHECK(LogicUtils::Choose(4, 1.0, 2.0, 3.0, 4.0) == 4.0);
